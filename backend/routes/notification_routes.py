...
@router.post("/notifications/quick/match-found")
...
@router.post("/notifications/quick/session-reminder")
...
@router.post("/notifications/quick/achievement-earned")
...
@router.post("/notifications/quick/message-received")
