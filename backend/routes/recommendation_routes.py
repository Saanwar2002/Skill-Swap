...
@router.post("/recommendations/generate/{recommendation_type}")
...
@router.put("/recommendations/{recommendation_id}/viewed")
...
@router.put("/recommendations/{recommendation_id}/acted-upon")
...
@router.get("/recommendations/learning-goals", response_model=List[LearningGoal])
...
@router.post("/recommendations/learning-goals", response_model=LearningGoal)
...
@router.put("/recommendations/learning-goals/{goal_id}/progress")
